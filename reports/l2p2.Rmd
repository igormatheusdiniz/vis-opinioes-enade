...
### Levando em consideração as notas atribuidas na categoria de Curso em geral, quais foram as universidades que obtiveram as melhores colocações? {data-commentary-width=400}
```{r}
...
### Um pouco mais sobre as IES melhores classificadas  {data-commentary-width=400}
```{r}
